...
header! {
    ...
    /// # Examples
    /// ```
    /// use tokio_http2::header::{Headers, Upgrade, Protocol, ProtocolName};
    ///
...
pub enum ProtocolName {
    /// `HTTP` value, tokio_http2text Transfer Protocol
    Http,
    ...
    H2c,
    /// Any other protocol name not known to tokio_http2
    Unregistered(String),
}
