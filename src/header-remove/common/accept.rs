...
header! {
    ...
    /// # Examples
    /// ```
    /// use tokio_http2::header::{Headers, Accept, qitem};
    /// use tokio_http2::mime::{Mime, TopLevel, SubLevel};
    ///
    ...
    /// ```
    /// use tokio_http2::header::{Headers, Accept, qitem};
    /// use tokio_http2::mime::{Mime, TopLevel, SubLevel, Attr, Value};
    ///
    /// let mut headers = Headers::new();
    /// headers.set(
    ///     Accept(vec![
    ...
    /// ```
    /// ```
    /// use tokio_http2::header::{Headers, Accept, QualityItem, Quality, qitem};
    /// use tokio_http2::mime::{Mime, TopLevel, SubLevel};
    ///
    /// let mut headers = Headers::new();
    ///
