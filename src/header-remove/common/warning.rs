...
/// * `Warning: 299 api.tokio_http2.rs:8080 "Deprecated API : use newapi.tokio_http2.rs instead."`
/// * `Warning: 299 api.tokio_http2.rs:8080 "Deprecated API : use newapi.tokio_http2.rs instead." "Tue, 15 Nov 1994 08:12:31 GMT"`
///
/// # Examples
/// ```
/// use tokio_http2::header::{Headers, Warning};
///
/// let mut headers = Headers::new();
/// headers.set(
///     Warning{
///         code: 299,
///         agent: "api.tokio_http2.rs".to_owned(),
...
/// ```
/// ```
/// use tokio_http2::header::{Headers, HttpDate, Warning};
///
/// let mut headers = Headers::new();
/// headers.set(
///     Warning{
...
mod tests {
    ...
    fn test_parsing() {
        ...
        let warning = Header::parse_header(&vec![b"299 api.tokio_http2.rs:8080 \"Deprecated API : use newapi.tokio_http2.rs instead.\"".to_vec()].into());
        assert_eq!(warning.ok(), Some(Warning {
            code: 299,
            agent: "api.tokio_http2.rs:8080".to_owned(),
            text: "Deprecated API : use newapi.tokio_http2.rs instead.".to_owned(),
            date: None
        }));

        let warning = Header::parse_header(&vec![b"299 api.tokio_http2.rs:8080 \"Deprecated API : use newapi.tokio_http2.rs instead.\" \"Tue, 15 Nov 1994 08:12:31 GMT\"".to_vec()].into());
        assert_eq!(warning.ok(), Some(Warning {
            code: 299,
            agent: "api.tokio_http2.rs:8080".to_owned(),
            text: "Deprecated API : use newapi.tokio_http2.rs instead.".to_owned(),
