...
/// # Example
/// ```
/// use tokio_http2::header::{Headers, ContentLength};
///
...
__tokio_http2__deref!(ContentLength => u64);
__tokio_http2_generate_header_serialization!(ContentLength);

__tokio_http2__tm!(ContentLength, tests {
    // Testcase from RFC
