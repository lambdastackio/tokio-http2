...
#[doc(hidden)]
#[macro_export]
macro_rules! __tokio_http2__deref {
    ($from:ty => $to:ty) => {
...
#[doc(hidden)]
#[macro_export]
macro_rules! __tokio_http2_generate_header_serialization {
    ($id:ident) => {
...
macro_rules! header {
    ...
    ($(#[$a:meta])*($id:ident, $n:expr) => ($item:ty)*) => {
        ...
        __tokio_http2__deref!($id => Vec<$item>);
        ...
        __tokio_http2_generate_header_serialization!($id);
    };
