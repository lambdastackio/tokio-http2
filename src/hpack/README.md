...
The following Huffman code is used when encoding string literals with a Huffman coding.

This Huffman code was generated from statistics obtained on a large sample of HTTP headers. It is a canonical Huffman code with some tweaking to ensure that no symbol has a unique code length.
...
Some portions initially used from https://github.com/mlalic/hpack-rs
